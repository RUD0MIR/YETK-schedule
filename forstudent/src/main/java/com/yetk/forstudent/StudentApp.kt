...
import com.yetk.forstudent.ui.navigation.StudentNavHost
...
@Composable
fun StudentApp(appState: StudentAppState = rememberStudentAppState()) {
    val snackbarHostState = remember { SnackbarHostState() }
    val showBottomBar =
        appState.currentDestination?.route != "authorization" &&
