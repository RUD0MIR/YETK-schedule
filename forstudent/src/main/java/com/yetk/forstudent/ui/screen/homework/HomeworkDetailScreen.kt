...
import com.yetk.forstudent.common.Const.AUTO_INCREMENT_ID
            ...
            Column(
                ...
                AutoComplete(
                    ...
                    if (autoCompleteExpanded) {
                        ...
                        stringResource(R.string.expand_action)
                    },
            ...
            if (checkCorrectInput(subjectTfValue, contentTfValue)) {
                YetkFilledButton(
                    ...
                    if (isEditScreen) {
                        ...
                        onHomeworkInsert(
                            Homework(AUTO_INCREMENT_ID, contentTfValue, subjectTfValue)
                        )
                    }
                    onNavigateUp()
                }
