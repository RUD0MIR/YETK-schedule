...
@Composable
internal fun BellScheduleRoute(bellSchedule: Response<BellSchedule>) {
    BellScheduleScreen(
        bellSchedule
    )
}
...
@Composable
fun BellScheduleScreen(bellSchedule: Response<BellSchedule>) {
        ...
        is Response.Success -> {
            ...
            Box(modifier = Modifier.fillMaxSize()) {
                LazyColumn {
                    item {
                        BellScheduleHeader(
                            stringResource(R.string.lessons_duration),
                            lessonDurationMin
                        )
                    }
...
@Composable
fun BellScheduleListItem(number: Int, time: String) {
    Column(
        modifier =
        Modifier
            .fillMaxWidth()
