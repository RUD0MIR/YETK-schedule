...
sealed interface HomeworkEvent {
    data class InsertHomework(val homework: com.yetk.model.Homework): HomeworkEvent
    ...
    data class UpdateHomework(val homework: com.yetk.model.Homework): HomeworkEvent
